                ...
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="{{Route('login')}}" method="post">
                            ...
                            <div class="form-group">
                                <label for="remember-me" class="text-info"><span>{{ __('به خاطر بسپار') }}</span> <span><input id="remember-me" name="remember-me" type="checkbox"></span></label><br>
                                <input type="submit" name="submit" class="btn btn-info btn-md" value="ورود">
                            </div>
                            <div id="register-link" class="text-right">
                                <a href="#" class="text-info">ایجاد حساب جدید</a>
                            </div>
                        </form>
                    </div>
                </div>
